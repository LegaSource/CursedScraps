...
public class BeltBagInventoryUIPatch
{
    ...
    private static bool PreDropObject(ref BeltBagInventoryUI __instance, int slot)
    {
            ...
            && !ObjectCSManager.PreDropObject(__instance.currentBeltBag.playerHeldBy, grabbableObject))
        {
            ...
            {
                CursedScrapsNetworkManager.Instance.RemoveFromBagEveryoneRpc(grabbableObject.GetComponent<NetworkObject>(), __instance.currentBeltBag.GetComponent<NetworkObject>());
